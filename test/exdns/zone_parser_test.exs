defmodule Exdns.ZoneParserTest do
  ...
  test "json record to A RR" do
    ...
    data = %{"ip" => "1.2.3.4"}
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "A", "ttl" => ttl, "data" => data})
  ...
  test "json record to AAAA RR" do
    name = "example.com"; ttl = 3600
    data = %{"ip" => "::1"}
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "AAAA", "ttl" => ttl, "data" => data})
  ...
  test "json record to CNAME RR" do
    ...
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "CNAME", "ttl" => ttl, "data" => data})
  ...
  test "json record to HINFO RR" do
    ...
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "HINFO", "ttl" => ttl, "data" => data})
  ...
  test "json record to MX RR" do
    ...
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "MX", "ttl" => ttl, "data" => data})
  ...
  test "json record to NAPTR RR" do
    ...
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "NAPTR", "ttl" => ttl, "data" => data})
  ...
  test "json record to RP RR" do
    ...
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "RP", "ttl" => ttl, "data" => data})
  ...
  test "json record to SPF RR" do
    name = "example.com"; ttl = 3600
    data = %{"spf" => "v=spf1 -all"}
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "SPF", "ttl" => ttl, "data" => data})
  ...
  test "json record to SRV RR" do
    ...
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "SRV", "ttl" => ttl, "data" => data})
  ...
  test "json record to SSHFP RR" do
    ...
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "SSHFP", "ttl" => ttl, "data" => data})
  ...
  test "json record to TXT RR" do
    ...
    rr = Exdns.ZoneParser.json_record_to_rr(%{"name" => name, "type" => "TXT", "ttl" => ttl, "data" => data})
