defmodule Exdns.Server.Supervisor do
  ...
  def define_servers([]) do
    [
      ...
      #worker(Exdns.Server.UdpServer, [:udp_inet6, :inet6], id: :udp_inet6, restart: :permanent, timeout: 5000),
      #worker(Exdns.Server.TcpServer, [:tcp_inet, :inet], id: :tcp_inet, restart: :permanent, timeout: 5000),
