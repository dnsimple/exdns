defmodule Exdns.Zone.Parser do
  ...
  def json_record_to_rr(%{"name" => name, "type" => "CNAME", "ttl" => ttl, "data" => data}) do
    ...
    Exdns.Records.dns_rr(name: name, type: @_DNS_TYPE_CNAME, data: rrdata, ttl: ttl)
  end
  ...
  def json_record_to_rr(%{"name" => name, "type" => "HINFO", "ttl" => ttl, "data" => data}) do
    ...
    Exdns.Records.dns_rr(name: name, type: @_DNS_TYPE_HINFO, data: rrdata, ttl: ttl)
  end
  ...
  def json_record_to_rr(%{"name" => name, "type" => "NS", "ttl" => ttl, "data" => data}) do
    ...
    Exdns.Records.dns_rr(name: name, type: @_DNS_TYPE_NS, data: rrdata, ttl: ttl)
  end
  ...
  def json_record_to_rr(%{"name" => name, "type" => "RP", "ttl" => ttl, "data" => data}) do
    ...
    Exdns.Records.dns_rr(name: name, type: @_DNS_TYPE_RP, data: rrdata, ttl: ttl)
  end
  ...
  def json_record_to_rr(%{"name" => name, "type" => "SPF", "ttl" => ttl, "data" => data}) do
    ...
    Exdns.Records.dns_rr(name: name, type: @_DNS_TYPE_SPF, data: rrdata, ttl: ttl)
  end
  ...
  def json_record_to_rr(%{"name" => name, "type" => "TXT", "ttl" => ttl, "data" => data}) do
    ...
    Exdns.Records.dns_rr(name: name, type: @_DNS_TYPE_TXT, data: rrdata, ttl: ttl)
  end
